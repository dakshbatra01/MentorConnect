        ...
        <div className="flex flex-col justify-center p-8 md:p-12">
          <div className="layout-content-container flex flex-col w-full max-w-md mx-auto">
            <div className="flex flex-wrap justify-between gap-3">
              <p className="text-slate-800 dark:text-white text-4xl font-black leading-tight tracking-[-0.033em] min-w-72">Welcome Back</p>
            </div>
            <p className="text-slate-600 dark:text-slate-400 text-base font-normal leading-normal pt-4 pb-6">Log in to continue your journey.</p>
            {error && (
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              <p className="text-center text-sm text-slate-600 dark:text-slate-400 mt-6">
                ...
                <Link className="font-semibold text-primary hover:underline ml-1" to="/signup">Sign Up</Link>
              </p>
            </form>
          </div>
        </div>
